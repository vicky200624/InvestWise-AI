...
import { LayoutDashboard, PieChart, Search, Eye, Settings, User } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="p-4 border-t border-[var(--color-border)] space-y-2">
        ...
        <button id="nav-profile" className="flex items-center px-4 py-2 w-full text-sm text-[var(--color-text-secondary)] hover:text-white transition-colors">
